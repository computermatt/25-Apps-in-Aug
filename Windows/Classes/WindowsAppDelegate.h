...
@class WindowsViewController;

@interface WindowsAppDelegate : NSObject <UIApplicationDelegate> {
    UIWindow *window;
    WindowsViewController *viewController;
}

@property (nonatomic, retain) IBOutlet UIWindow *window;
@property (nonatomic, retain) IBOutlet WindowsViewController *viewController;
