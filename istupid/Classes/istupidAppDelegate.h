...
@class istupidViewController;

@interface istupidAppDelegate : NSObject <UIApplicationDelegate> {
    UIWindow *window;
    istupidViewController *viewController;
}

@property (nonatomic, retain) IBOutlet UIWindow *window;
@property (nonatomic, retain) IBOutlet istupidViewController *viewController;
