...
@class epochViewController;

@interface epochAppDelegate : NSObject <UIApplicationDelegate> {
    UIWindow *window;
    epochViewController *viewController;
}

@property (nonatomic, retain) IBOutlet UIWindow *window;
@property (nonatomic, retain) IBOutlet epochViewController *viewController;
