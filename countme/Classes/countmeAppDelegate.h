...
@class countmeViewController;

@interface countmeAppDelegate : NSObject <UIApplicationDelegate> {
    UIWindow *window;
    countmeViewController *viewController;
}

@property (nonatomic, retain) IBOutlet UIWindow *window;
@property (nonatomic, retain) IBOutlet countmeViewController *viewController;
