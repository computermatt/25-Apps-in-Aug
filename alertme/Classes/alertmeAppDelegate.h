...
@class alertmeViewController;

@interface alertmeAppDelegate : NSObject <UIApplicationDelegate> {
    UIWindow *window;
    alertmeViewController *viewController;
}

@property (nonatomic, retain) IBOutlet UIWindow *window;
@property (nonatomic, retain) IBOutlet alertmeViewController *viewController;
