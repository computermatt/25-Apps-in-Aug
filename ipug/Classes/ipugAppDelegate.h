...
@class ipugViewController;

@interface ipugAppDelegate : NSObject <UIApplicationDelegate> {
    UIWindow *window;
    ipugViewController *viewController;
}

@property (nonatomic, retain) IBOutlet UIWindow *window;
@property (nonatomic, retain) IBOutlet ipugViewController *viewController;
